...
typealias MoviesCollectionManager_Protocols = MoviesCollectionManager
typealias MoviesCollectionManager_CellCreator = MoviesCollectionManager
...
class MoviesCollectionManager: NSObject {
    ...
    var collection: UICollectionView? { didSet { self.registerCells() } }
...
extension MoviesCollectionManager_Protocols: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
extension MoviesCollectionManager_CellCreator {
